      ...
      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
        {urls.slice(0, 10).map((url, i) => (
          <button
            ...
            aria-label={locale === 'zh-TW' ? `查看 ${gameName} 截圖 ${i + 1}` : `查看 ${gameName} 截图 ${i + 1}`}
          >
            <img
              src={url}
              alt={locale === 'zh-TW' ? `${gameName} 截圖 ${i + 1}` : `${gameName} 截图 ${i + 1}`}
        ...
        >
          ...
          >
            <img
              ...
              alt={locale === 'zh-TW' ? `${gameName} 截圖 ${activeIndex + 1}` : `${gameName} 截图 ${activeIndex + 1}`}
