...
import { gamesListConfig } from '@/config/customize/pages/games'
...
export async function generateMetadata({
  ...
  }, locale === defaultLocale ? `${siteConfig.hostname}/games` : `${siteConfig.hostname}/${locale}/games`, '/games')
}
  ...
  return (
    <div className="bg-slate-950 min-h-screen">
      <JsonLd data={buildCollectionPageSchema({
        ...
        url: locale === defaultLocale ? `${siteConfig.hostname}/games` : `${siteConfig.hostname}/${locale}/games`,
      })} />
