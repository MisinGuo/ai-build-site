...
import { boxesListConfig } from '@/config/customize/pages/boxes'
...
export async function generateMetadata({
  ...
  }, locale === defaultLocale ? `${siteConfig.hostname}/boxes` : `${siteConfig.hostname}/${locale}/boxes`, '/boxes')
}
    ...
    <div className="bg-slate-950 min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-7xl">
        <JsonLd data={buildCollectionPageSchema({
          ...
          url: locale === defaultLocale ? `${siteConfig.hostname}/boxes` : `${siteConfig.hostname}/${locale}/boxes`,
        })} />
