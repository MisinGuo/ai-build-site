...
**游戏盒子 CMS** 是基于若依框架开发的游戏推广内容管理系统。

### 核心特点

* **多站点管理**：统一后台管理多个推广站点内容
* **边缘前端**：Next.js 推广站点部署在 Cloudflare 边缘网络，SEO 友好
* **AI 内容生成**：集成 AI 自动生成游戏攻略、评测等高质量内容
* **智能关联**：游戏盒子、游戏、文章的多对多关系管理
* **全文搜索**：基于 ElasticSearch 的高性能搜索引擎

### 技术栈

**后端：**
* 框架采用若依 Boot (Spring Boot 3.x)
* 权限认证使用 Jwt，支持多终端认证系统
* 数据库使用 MySQL 8.0，缓存使用 Redis 6.x
* 搜索引擎使用 ElasticSearch 8.x

**管理后台：**
* 前端采用若依 Vue3、Element Plus
* 支持加载动态权限菜单，多方式轻松权限控制
* 高效率开发，使用代码生成器可以一键生成前后端代码

**推广站点（Next-web）：**
* 前端采用 Next.js 14、React 18、Tailwind CSS
* 部署在 Cloudflare Workers，全球 CDN 加速
* SSR/ISR 渲染，优化 SEO 和首屏性能
* 响应式设计，支持 PC 和移动端 H5
* 集成 GitHub Actions，自动化内容生成
...
├── ruoyi-gamebox/         # 游戏盒子业务模块
├── ruoyi-system/          # 系统管理模块
├── RuoYi-Vue3/            # 管理后台前端（Vue3）
├── Next-web/              # 推广站点前端（Next.js）
├── docs/                  # 项目文档
└── sql/                   # 数据库脚本
```
